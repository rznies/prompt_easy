...
const improveEngine_1 = require("../src/improveEngine");
describe('Phase 1a: LLM Interface Setup (Issue #2)', () => {
    let engine;
    beforeEach(() => {
        engine = new improveEngine_1.PromptEasyEngine({
    ...
    describe('Acceptance Criteria: callLLM interface', () => {
        it('AC3: callLLM interface exists and accepts provider, model, and apiKey', async () => {
            ...
            expect(typeof improveEngine_1.callLLM).toBe('function');
        });
...
//# sourceMappingURL=improveEngine.test.js.map